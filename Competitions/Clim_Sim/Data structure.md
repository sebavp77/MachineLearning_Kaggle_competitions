...
For a detailed description of the variables names and units the reader is referred to the documentation of the official competition.

An example of the training dataset is:

| state_t_0 | state_t_1 | ... | state_ps | ... |
| :--- | :--- | :---: | :--- | :---: |
